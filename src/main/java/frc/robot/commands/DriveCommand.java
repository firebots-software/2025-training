...
public class DriveCommand extends Command {
  ...
  private Supplier<Double> joystickValue2;
   ...
   */
  public DriveCommand(XRPDrivetrain subsystem, Supplier<Double> fattie, Supplier<Double> bigBack) {
    xrp = subsystem;
    joystickValue = fattie;
    joystickValue2 = bigBack;
  ...
  public void execute() {
    ...
    xrp.arcadeDrive(joystickValue.get(), joystickValue2.get());
